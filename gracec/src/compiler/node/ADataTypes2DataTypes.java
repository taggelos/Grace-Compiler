...
public final class ADataTypes2DataTypes extends PDataTypes
{
    private TChar _char_;

    public ADataTypes2DataTypes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADataTypes2DataTypes(
    ...
    {
        ((Analysis) sw).caseADataTypes2DataTypes(this);
    }
