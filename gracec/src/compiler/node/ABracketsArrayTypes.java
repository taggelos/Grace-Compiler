...
public final class ABracketsArrayTypes extends PArrayTypes
{
    private TLBr _lBr_;
    private TIntegers _integers_;
    private TRBr _rBr_;

    public ABracketsArrayTypes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABracketsArrayTypes(
    ...
    {
        ((Analysis) sw).caseABracketsArrayTypes(this);
    }
