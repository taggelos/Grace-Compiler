...
public final class AReturnstmt2Returnstmt extends PReturnstmt
{
    private TReturn _return_;
    private PExpr _expr_;
    private TSemi _semi_;

    public AReturnstmt2Returnstmt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReturnstmt2Returnstmt(
    ...
    {
        ((Analysis) sw).caseAReturnstmt2Returnstmt(this);
    }
