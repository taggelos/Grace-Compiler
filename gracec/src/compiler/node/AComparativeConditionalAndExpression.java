...
public final class AComparativeConditionalAndExpression extends PConditionalAndExpression
{
    private PComparativeExpression _comparativeExpression_;

    public AComparativeConditionalAndExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComparativeConditionalAndExpression(
    ...
    {
        ((Analysis) sw).caseAComparativeConditionalAndExpression(this);
    }
