...
public final class AGreaterEqualThanExpr extends PExpr
{
    private PExpr _left_;
    private PExpr _right_;

    public AGreaterEqualThanExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterEqualThanExpr(
    ...
    {
        ((Analysis) sw).caseAGreaterEqualThanExpr(this);
    }
