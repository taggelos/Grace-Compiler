...
public final class AReturnType2ReturnType extends PReturnType
{
    private TNothing _nothing_;

    public AReturnType2ReturnType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReturnType2ReturnType(
    ...
    {
        ((Analysis) sw).caseAReturnType2ReturnType(this);
    }
